...
export enum SuccessCodes {
  ...
  HTTP_203_NOT_AUTHORITATIVE_INFORMATION = 203,
...
export enum ClientError {
  ...
  HTTP_422_UNPROCESSABLE_ENTITY = 418,
  HTTP_423_LOCKED = 419,
  HTTP_424_FAILED_DEPENDENCY = 420,
  HTTP_426_UPGRADE_REQUIRED = 421,
  HTTP_428_PRECONDITION_REQUIRED = 428,
  HTTP_429_TOO_MANY_REQUESTS = 429,
  HTTP_431_REQUEST_HEADER_FIELDS_TOO_LARGE = 424,
  HTTP_451_UNAVAILABLE_FOR_LEGAL_REASONS = 425
}
...
export class ErrorService {
  ...
  constructor(private _ui:UtilService) { }
  ...
  userNotification(notificationCde: number, notification: string) {
    switch (notificationCde) {
      case SuccessCodes.HTTP_200_OK:
        // this._ui.openErrorSnackBar(notification);
        alert(notification);
        break;
      default:
