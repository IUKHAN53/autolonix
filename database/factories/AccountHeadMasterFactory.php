...
class AccountHeadMasterFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'parent_account_id' => $this->faker->numberBetween(1, 100),
            ...
            'account_name_arabic' => $this->faker->text(50),
            'alias_name' => $this->faker->text(50),
            'level_no' => $this->faker->numberBetween(1, 10),
            'account_balance_type' => $this->faker->randomElement(['Type X', 'Type Y', 'Type Z']),
            'group_type' => $this->faker->randomElement(['Group A', 'Group B', 'Group C']),
            ...
            'area_arabic' => $this->faker->text(50),
            'po_box' => $this->faker->postcode,
            'telephone' => $this->faker->phoneNumber,
            'mobile_no' => $this->faker->phoneNumber,
            'fax_no' => $this->faker->phoneNumber,
            'email' => $this->faker->email,
            'payment_mode' => $this->faker->randomElement(['Mode A', 'Mode B', 'Mode C']),
            ...
            'managed_by' => $this->faker->numberBetween(1, 100),
            'upload_status' => $this->faker->randomElement(['PENDING', 'COMPLETE']),
